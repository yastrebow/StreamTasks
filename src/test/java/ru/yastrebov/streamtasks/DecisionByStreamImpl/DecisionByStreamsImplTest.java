...
class DecisionByStreamsImplTest {
    private final Enum<Nationality> nationality = JEW;
    private final DecisionByStreamsImpl decisionByStreams = new DecisionByStreamsImpl();
    ...
    @Test
    void peopleOverEighteen() {
        List<Person> peopleOverEighteenList = List.of(p1, p2, p3, p4, p5, p7, p8, p10, p11, p13, p14);
        List<Person> people = decisionByStreams.peopleOverEighteen(testListOfPeople);
    ...
    void averageAgeTest() {
        ...
        double averageAge = decisionByStreams.averageAge(testListOfPeople);
    ...
    void peopleOfEachNationalityTest() {
        Map<String, Integer> peopleOfEachNationality = decisionByStreams.peopleOfEachNationality(testListOfPeople);
    ...
    void listByLastnameTest() {
        Map<String, List<Person>> listByLastname = decisionByStreams.listByLastname(testListOfPeople);
